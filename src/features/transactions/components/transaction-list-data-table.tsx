...
export const TransactionDataTable = ({ transactions, isLoading, total }: TransactionDataTableProps) => {
    ...
    () => [
      ...
      },
      {
        ...
        cell: ({ row: { original: data } }) =>
          formatDateFromPattern(data.created_at || data.date, "dd/MM/yyyy - HH:mm:ss"),
        meta: {
          className: "w-[12%]",
        },
      },

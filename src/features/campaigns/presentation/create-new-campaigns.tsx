                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) => setFormData({ ...formData, dailyBudgetCap: checked as boolean })}
                          />
                            ...
                            <div className="space-y-2 text-sm">
                              <div className="flex justify-between">
                                ...
                                <span className="font-medium">
                                  ${Number.parseInt(formData.budget).toLocaleString()}
                                </span>
                              </div>
                              <div className="flex justify-between">
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="text-sm text-gray-700">
                            ...
                            <p>
                              ...
                              to affiliates. This ensures your budget is used on real results, and motivates affiliates
                              to deliver qualified outcomes that match your expectations.
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="space-y-4">
                      <div className="border-2 border-dashed border-border rounded-lg p-8 text-center">
                        ...
                        <p className="text-xs text-muted-foreground mt-2">
                          Supported: JPEG, PNG, MP4, HTML files, URLs
                        </p>
                      </div>
